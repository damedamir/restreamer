...
echo "🗄️ Complete Database Fix - All Tables"
echo "====================================="
...
docker-compose exec postgres psql -U postgres -d custom_restreamer -c "\dt" || echo "No tables found"

# Create all tables manually using SQL
echo "📝 Creating all tables manually..."
docker-compose exec postgres psql -U postgres -d custom_restreamer << 'EOF'
-- Create users table
