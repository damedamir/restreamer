...
export default function AdminPage() {
  ...
  // Get the base URL for branded URLs
  const getBaseUrl = () => {
    if (typeof window !== 'undefined') {
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    readOnly
                    value={`<iframe src="${getBaseUrl()}/embed/stream" width="800" height="450" frameborder="0" allowfullscreen></iframe>`}
                    className="w-full h-32 px-3 py-2 bg-gray-700 text-white rounded-md border border-gray-600 font-mono text-sm"
                  />
                  <button
                    onClick={() => copyToClipboard(`<iframe src="${getBaseUrl()}/embed/stream" width="800" height="450" frameborder="0" allowfullscreen></iframe>`)}
