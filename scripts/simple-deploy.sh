...
# Simple Deployment Script for Custom Restreamer
echo "🚀 Simple Deployment Script for Custom Restreamer"
echo "================================================="

# Check if domain is provided
if [ -z "$1" ]; then
    echo "❌ Please provide your domain name"
    echo "Usage: ./scripts/simple-deploy.sh yourdomain.com"
    echo "Example: ./scripts/simple-deploy.sh hive.restreamer.website"
    exit 1
fi
